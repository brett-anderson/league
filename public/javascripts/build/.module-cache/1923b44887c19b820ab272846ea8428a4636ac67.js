...
var ParticipantList = React.createClass({displayName: "ParticipantList",
  ...
  render: function(){
    console.log("Render ParticipantList " + 'state: ' + this.state + "props: " + this.props);
...
var Bet = React.createClass({displayName: "Bet", 
  ...
  render: function() {
    console.log("Render Bet " + 'state: ' + this.state + "props: " + this.props);
    return (
...
var BetContainer = React.createClass({displayName: "BetContainer",
  ...
  render: function() {
    console.log("Render BetContainer " + 'state: ' + this.state + "props: " + this.props);
    return (
...
var BetForm = React.createClass({displayName: "BetForm",
  ...
  render: function() {
    console.log("Render BetForm " + 'state: ' + this.state + "props: " + this.props);
    return (
